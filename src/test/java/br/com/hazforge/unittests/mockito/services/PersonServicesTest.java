package br.com.hazforge.unittests.mockito.services;
...
import br.com.hazforge.unittests.mapper.mocks.MockPerson;
...
class PersonServicesTest {
	...
	void testFindByIdNotFound() {
		Exception excepetion = assertThrows(ResourceNotFoundException.class, () -> {
			service.findById(1L);
		});
